...
public class SimpleObjectMenuGlue extends CukeGlueAbstract {
    ...
    public void there_are_N_simple_objects(int n) throws Throwable {
        try {
            final List<Student> list = simpleObjectMenu().listAll();
    ...
    public void create_a_simple_object() throws Throwable {
        simpleObjectMenu().create(UUID.randomUUID().toString(),"Fixed Name");
    }

    private StudentMenu simpleObjectMenu() {
        return service(StudentMenu.class);
    }
